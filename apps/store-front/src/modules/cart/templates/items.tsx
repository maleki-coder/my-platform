          ...
          .map((item: StoreCartLineItem) => (
            ...
            >
              ...
              <div className="absolute left-3 top-2 z-5">
                <DeleteButton id={item.id} className="w-full h-full flex justify-center items-center cursor-pointer p-2 border rounded-4xl" />
              </div>
                    ...
                    <div className=" mr-5 flex items-center justify-end self-end">
                      <div className="w-44 xl:w-8/12">
                        <div className="relative flex w-full justify-end">
                          <QuantitySelector item={item} countryCode={"ir"} />
                        </div>
                      </div>
                    </div>
                  </div>
