...
const ProductInfoSection = ({ product }: ProductInfoProps) => {
  return (
    <div
      id="product-info"
      className="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-6 grow md:rounded-2xl xl:min-w-185.5 2xl:min-w-0 2xl:max-w-300 bg-white shadow-custom p-0 md:p-6 mx-auto"
    >
