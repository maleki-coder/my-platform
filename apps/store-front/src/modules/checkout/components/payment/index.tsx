              ...
              <div className="flex justify-between rounded-2xl border-none bg-indigo-50 px-8 py-5">
                <div className="flex max-w-[64%] items-center gap-6">
                  <div className="flex w-full flex-col gap-y-1.5">
                    <div className="whitespace-nowrap flex items-center gap-3 leading-7 xl:leading-7.5 text-xs md:text-sm font-medium text-gray-800">
                      <span>
                        <CoinsIcon size={14} />
                      </span>
                ...
                <div className="text-gray-600 flex shrink-0! items-center cursor-pointer gap-1.5">
                  <div
                    onClick={handleEdit}
                    className="inline-block text-xs leading-5 xl:text-sm"
                  >
